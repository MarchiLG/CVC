...
CATALOG: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "view.triggers.subtitle": "Condition → action rules that react to alerts and drive external devices.",
        ...
        "settings.model_hint": "Models found under models/<kind>/. Add a checkpoint to that folder to see it here.",
        "settings.model_missing": "missing",
        "settings.model_missing_warning": "The saved model \"{path}\" was not found under models/ — this task will fail to build until the file is restored or a different model is chosen.",
        ...
        "settings.other_params": "Other parameters",
        "settings.other_params_hint": "Type-specific tuning for this task — pre-filled with working defaults when the task was added.",
        "settings.other_params_invalid": "\"{key}\" is not valid JSON — value not saved.",
        ...
        # ---- Triggers view
        "triggers.mode.ask": "Ask for permission",
        "triggers.mode.auto": "Auto mode",
        "triggers.mode_hint": "Ask mode queues matched actions below for approval; Auto mode fires them immediately.",
        "triggers.mode_saved": "Mode set to {mode}.",
        "triggers.new_rule": "New rule id",
        "triggers.new_rule_placeholder": "e.g. jam-stops-conveyor",
        "triggers.add": "Add rule",
        "triggers.empty.title": "No trigger rules yet",
        "triggers.empty.body": "Add a rule above to react to an alert by driving an external device.",
        "triggers.pending_title": "Pending approvals",
        "triggers.pending_empty": "Nothing waiting for approval.",
        "triggers.condition.task_type": "Task type",
        "triggers.condition.flag_id": "Flag id",
        "triggers.condition.flag_id_placeholder": "e.g. count_threshold",
        "triggers.condition.camera_id": "Camera",
        "triggers.condition.severity": "Severity",
        "triggers.any": "(any)",
        "triggers.then": "Then ({count})",
        "triggers.action.add": "Add action",
        "triggers.save_note": "Saving writes to Triggers.yaml and reloads the trigger engine.",
        "triggers.confirm_remove": "Remove the trigger rule \"{id}\"?",
        "triggers.added": "Trigger rule \"{id}\" added.",
        "triggers.removed": "Trigger rule removed.",
        "triggers.saved": "Trigger rule \"{id}\" saved and applied.",
        "triggers.invalid_target_json": "Action target for \"{type}\" is not valid JSON.",
        "triggers.pending.approve": "Approve",
        "triggers.pending.deny": "Deny",
        "triggers.pending.approved": "Action approved and executed.",
        "triggers.pending.denied": "Action denied.",
        ...
        "flag.car_identified": "Car #{track_id}: {trademark} / {color} / {plate_text}",
        "flag.possible_failed_print": "Possible failed print: area x{area_ratio}, irregularity {irregularity}",
        ...
        "api.unauthorized": "Your session has expired — unlock the application again.",
        ...
        "api.unknown_model_type": "Unknown model type.",
        "api.trigger_rule_already_exists": "A trigger rule with this id already exists.",
        "api.trigger_rule_not_found": "That trigger rule does not exist.",
        "api.invalid_trigger_mode": "Mode must be \"ask\" or \"auto\".",
        "api.pending_action_not_found": "That pending action no longer exists — it may have already been approved or denied.",
    ...
    "pt": {
        ...
        "view.triggers.subtitle": "Regras de condição → ação que reagem a alertas e acionam dispositivos externos.",
        ...
        "settings.model_hint": "Modelos encontrados em models/<tipo>/. Adicione um checkpoint nessa pasta para vê-lo aqui.",
        "settings.model_missing": "ausente",
        "settings.model_missing_warning": "O modelo salvo \"{path}\" não foi encontrado em models/ — esta tarefa vai falhar ao construir até o arquivo ser restaurado ou outro modelo ser escolhido.",
        ...
        "settings.other_params": "Outros parâmetros",
        "settings.other_params_hint": "Ajustes específicos deste tipo de tarefa — preenchidos com valores padrão funcionais quando a tarefa foi adicionada.",
        "settings.other_params_invalid": "\"{key}\" não é um JSON válido — valor não salvo.",
        "settings.flags": "Flags ({count})",
        ...
        # ---- Triggers view
        "triggers.mode.ask": "Pedir permissão",
        "triggers.mode.auto": "Modo automático",
        "triggers.mode_hint": "No modo de pedir permissão, as ações correspondentes ficam na fila abaixo aguardando aprovação; no modo automático elas são disparadas na hora.",
        "triggers.mode_saved": "Modo definido como {mode}.",
        "triggers.new_rule": "Id da nova regra",
        "triggers.new_rule_placeholder": "ex.: jam-stops-conveyor",
        "triggers.add": "Adicionar regra",
        "triggers.empty.title": "Nenhuma regra de gatilho ainda",
        "triggers.empty.body": "Adicione uma regra acima para reagir a um alerta acionando um dispositivo externo.",
        "triggers.pending_title": "Aprovações pendentes",
        "triggers.pending_empty": "Nada aguardando aprovação.",
        "triggers.condition.task_type": "Tipo de tarefa",
        "triggers.condition.flag_id": "Id do flag",
        "triggers.condition.flag_id_placeholder": "ex.: count_threshold",
        "triggers.condition.camera_id": "Câmera",
        "triggers.condition.severity": "Severidade",
        "triggers.any": "(qualquer)",
        "triggers.then": "Então ({count})",
        "triggers.action.add": "Adicionar ação",
        "triggers.save_note": "Salvar grava em Triggers.yaml e recarrega o motor de gatilhos.",
        "triggers.confirm_remove": "Remover a regra de gatilho \"{id}\"?",
        "triggers.added": "Regra de gatilho \"{id}\" adicionada.",
        "triggers.removed": "Regra de gatilho removida.",
        "triggers.saved": "Regra de gatilho \"{id}\" salva e aplicada.",
        "triggers.invalid_target_json": "O destino da ação \"{type}\" não é um JSON válido.",
        "triggers.pending.approve": "Aprovar",
        "triggers.pending.deny": "Negar",
        "triggers.pending.approved": "Ação aprovada e executada.",
        "triggers.pending.denied": "Ação negada.",
        ...
        "flag.car_identified": "Carro #{track_id}: {trademark} / {color} / {plate_text}",
        "flag.possible_failed_print": "Possível falha de impressão: área x{area_ratio}, irregularidade {irregularity}",
        ...
        "api.unauthorized": "Sua sessão expirou — desbloqueie a aplicação novamente.",
        ...
        "api.unknown_model_type": "Tipo de modelo desconhecido.",
        "api.trigger_rule_already_exists": "Já existe uma regra de gatilho com esse id.",
        "api.trigger_rule_not_found": "Esta regra de gatilho não existe.",
        "api.invalid_trigger_mode": "O modo deve ser \"ask\" ou \"auto\".",
        "api.pending_action_not_found": "Essa ação pendente não existe mais — ela pode já ter sido aprovada ou negada.",
